  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] flex flex-col">
        ...
        {/* Error Display */}
        {error && (
          <div className="mx-6 mt-4 p-4 bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3\">
                  {filteredRepositories.map((repo) => (
                    <button
                      ...
                      className="text-left p-4 border border-gray-200 dark:border-slate-600 rounded-lg hover:border-blue-500 hover:shadow-md transition-all group"
                    >
                      <div className="flex items-start justify-between mb-2\">
                        ...
                        <div className="flex items-center gap-1 ml-2\">
                          ...
                          {repo.language && (
                            <span className="text-xs px-2 py-1 bg-gray-100 dark:bg-slate-700 rounded-full text-gray-600 dark:text-gray-400\">
                              {repo.language}
                            </span>
                          )}
                        </div>
            ...
            <div className="flex-1 overflow-auto\">
              {isLoadingFiles ? (
                ...
                <div className="divide-y divide-gray-200 dark:divide-slate-700\">
                  {filteredFiles.map((file) => (
                    <button
                      ...
                      className="w-full text-left px-6 py-3 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors flex items-center gap-3"
                    >
                      {/* File/Folder Icon */}
                      {file.type === 'dir' ? (
                ...
                <div className="text-center py-12\">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white\">No markdown files found</h3>
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400\">
