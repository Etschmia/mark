    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Save Options" maxWidth="md" zIndex={9999}>
      <div className="bg-white dark:bg-slate-800">
        ...
        <div className="p-6">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">Save to Local Device</span>
                  </div>
            ...
            <div className={`border rounded-lg p-4 ${
              ...
              <label className={`flex items-start gap-3 ${
                ...
                <input
                  ...
                  className="mt-1 w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-slate-600 disabled:opacity-50"
                />
                <div className="flex-1">
                  <div className="flex items-center gap-2">
          ...
          {commitError && (
            <div className="mt-4 p-3 bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
              ...
              <p className="mt-1 text-sm text-red-600 dark:text-red-300">{commitError}</p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 dark:border-slate-700">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg transition-colors"
          >
            Cancel
          </button>
